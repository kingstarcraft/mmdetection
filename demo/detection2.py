...
target_model = {
    ...
    'midog3': {
        ...
        'newgs3': {
            'train23': (
                f'F:/111/config.py',
                f'{model_root}/cascade_rcnn_r50_fpn_0.8_0.9_1280_1x_newgs3_va/epoch_2000.pth'),
            'train13': (
                f'F:/111/config.py',
                f'{model_root}/cascade_rcnn_r50_fpn_0.8_0.9_1280_1x_newgs3_vb/epoch_2000.pth'),
            'train12': (
                f'F:/111/config.py',
                f'{model_root}/cascade_rcnn_r50_fpn_0.8_0.9_1280_1x_newgs3_vc/epoch_2000.pth')
        }
    }
}
...
for method in ['test13', 'test12', 'reinhard', 'he', 'gsnew/gs']:
                ...
                for mtd, datasets in models.items():
                    for dataset, config in datasets.items():
                        ...
                        for source in os.listdir(input_root + '/' + method + '/' + target):
                            if source != 'midog3' or target != 'midog1':
                                continue
