...
host = '//192.168.80.53'
input_root = f'{host}/amax/cy/color_transfer/__pycache__'
output_root = f'{host}/amax/longxi/color_transfer_best'
model_root = f'{host}/amax/longxi/color_transfer/train/train/22_colortransfer'
ground_truth = f'{host}/home/amax/project/mmdetection/work/mitosis/gt'
config_root = f'{host}/amax/longxi/color_transfer/train/'
...
target_model = {
    'midog2': {
        'test122': {
            'train23': (
                f'{config_root}/config.py',
                f'{model_root}/cascade_rcnn_r50_fpn_0.8_0.9_1280_1x_test122_va/epoch_1067.pth'),
            #            'train13': (
            #                f'F:/111/config.py',
